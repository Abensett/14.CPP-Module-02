...
/*   Updated: 2022/06/16 22:57:00 by abensett         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
 ...
 */
static Fixed IsLeft(const Point a, const Point b, const Point c) {            // IsLeftulate (Ax - Bx)(Cy - Ay)
	Fixed tmp_1 = (b.get_x() - a.get_x()) * (c.get_y() - a.get_y());        //IsLeftulate (Ay - By)(Cx - Bx)
	Fixed tmp_2 = (b.get_y() - a.get_y()) * (c.get_x() - a.get_x());        // return la difference des deux
...
bool bsp(const Point a, const Point b, const Point c, const Point point) {  // check if a point is in the triangle
	...
	Fixed side3 = IsLeft(c, b, point);                                    // IsLeftulate the distance between the point and the triangle
